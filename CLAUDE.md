...
- Use black font, at least 10.5pt
- Use XCharter font (already configured in template)
- 0.5 inch margins (already configured)
...
- Format: **Job Title,** Company -- City, Country \\hfill Date Range \\\\
- Use "Present" for current positions
- Use full months (Jan, Feb, Mar, etc.) and years (2025, not '25)
- Use en dashes (–) with spaces for date ranges
- Right-align dates
- Order positions from most recent to oldest

### Bullet Points Rules (CRITICAL)
- Start each bullet with strong past-tense action verb
- Follow STAR method: Situation, Task, Action, Result
- Or XYZ method: Accomplished [X] as measured by [Y] by doing [Z]
- 1-2 lines long maximum
- Aim for 1 sentence per bullet
- Put metrics/results at the start if quantifiable
- No personal pronouns (I, we, us, my, our)
- No periods at end of bullets
- Order bullets from most impressive to least
...
**Avoid these unnecessarily complex verbs:** amplified, conceptualized, crafted, elevated, employed, ensured, fostered, headed, honed, mastered, orchestrated, pioneered, revolutionized, spearheaded, transformed
...
### What NOT to Include
- Summary/profile (only for senior/staff with 10+ years)
- References section
